...
public class Usuario
{
    ...
    //constructor
    public Usuario(String nombre, String id, Fecha fechaNacimiento){
        this.nombre = nombre;
        this.id = id;
        monedas = 0;
        cantPasos = 0;
    ...
    public void setMonedas(int nuevaCantidadMonedas){
        monedas = nuevaCantidadMonedas;
    }
    public void setCantidadDePasos(int nuevaCantidadPasos){
        cantPasos = nuevaCantidadPasos;
    }
    public ArrayList<String> getHistorial(){
        return historialRecompensas;
    }
